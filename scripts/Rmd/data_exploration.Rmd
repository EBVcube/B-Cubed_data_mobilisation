---
title: <span style="color:#005857">IAS occurrence cubes<span>
subtitle: <span style="color:#47A52A">Data exploration
author: "**Authors**: Lina Estupinan-Suarez, Luise Quoss, <br>Emmanuel Oceguera, Miguel Fernandez"
date: "`r Sys.Date()`"
output:
 html_notebook:
    highlight: tango
---
<img src="C:\gitrepo\B-Cubed_data_mobilization\input\logos\B3_logo_full.png" style='width: 300px; position:absolute; top:0; right:0; padding:10px;'/>
---


### Introduction
In this script we explore the occurrence data of invasive alien species (IAS) of union concern (IAS) available in GBIF until June 2024.
To do this, an IAS occurrence cube was previously created through GBIF AP using the occurrence cube generation software developed in the [Biodiversity Building Blocks for policy project](https://b-cubed.eu/) (B3) funded by
the European Union’s Horizon Europe Research and Innovation Programme (ID No 101059592). 
...
After loading the requiered libraries, read the occurrence IAS cube obtained previously through GBIF.
