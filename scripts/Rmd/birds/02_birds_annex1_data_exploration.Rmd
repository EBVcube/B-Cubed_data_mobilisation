...
Details of the data query in GBIF are available at: [doi: ](https://www.gbif.org/occurrence/download/). 
...
xout <- merge(x=as.data.frame(cag_sp), y=tax[,c("scientificName", "key", "kingdom", "phylum", "class", "order", "family")], by="taxonKey") #
xout <- cag_sp %>% 
...
We will see the number of records since 1950.
...
# Read data (only for plot test)
# cag <- read.csv(here("output/summary_data/csv/summary_birds_total_occurrences_byfamily+order.csv"))
