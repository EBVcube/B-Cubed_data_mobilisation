...
subtitle: <span style="color:#47A52A"> Data exploration of species listed in the Birds Directive Annex I 
author: 
...
# Save file
write.csv(xout, here("output/summary_data/csv/summary_birds_total_occurrences_acceptedusagekey.csv"), quote = FALSE)
```
...
write.csv(noocc, here("output/summary_data/csv/birds_no_occurrences_acceptedusagekeys.csv"), quote = FALSE)
...
write.csv(gbif_spx2, here("input/data/birds/taxonomy/List168_BirdsAnnexI_gbif_accepted_ebvcube+acceptedUsageKey+ETCname.csv"), quote=FALSE)
write.csv(gbif_spx_missing, here("input/data/birds/taxonomy/List28_missing_BirdsAnnexI_gbif_accepted_ebvcube+acceptedUsageKey.csv"), quote=FALSE)
```
