...
subtitle: <span style="color:#47A52A"> Harmonisation of species keys for the JSON query <br> of species listed in the Annex I of the Birds Directive
author: 
...
tax <- read.csv(here("input/data/birds/taxonomy/list193birds_directive_annexi_match_gbif_updated.csv"))
```
