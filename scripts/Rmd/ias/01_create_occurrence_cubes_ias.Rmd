...
subtitle: <span style="color:#47A52A"> Prototype for creating a occurrence cube of IAS
author: 
...
### Introduction
In this notebook we create a cube of occurrence of invasive alien species (IAS) of union concern (IAS) based on all species records available in GBIF until June 2024.
...
Details of the GBIF data query are available at: [doi: 10.15468/dl.x4a25s](https://www.gbif.org/occurrence/download/0081452-240506114902167). 
...
response <- "0077925-240506114902167"
```
